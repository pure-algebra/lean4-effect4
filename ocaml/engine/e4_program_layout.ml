(* cut-from: rev=db17914 toolchain=4.33.1 inputs=a203d79d58a8a0af6f1d042ed761d39482ae4cbce7d611b2833f3b9d9fab8d5f *)
...
let source_ctor_names = [
  ...
  ("layer_terms", Eff_types.ctor_names_layer_terms);
  ("row_kind", Eff_types.ctor_names_row_kind);
  ("row_shape", Eff_types.ctor_names_row_shape);
  ("registration", Eff_types.ctor_names_registration)
]
...
let engine_ctor_names = [
  ...
  ("row_shape", ["call"; "value"; "tupleCall"; "method"]);
