...
let ctor_index_lit : lit -> int = function
  ...
  | Lit_bool _ -> 2
  | Lit_str _ -> 3
let wire_tag_lit : lit -> int = function
  | Lit_unit -> 0
  | Lit_nat _ -> 1
  | Lit_bool _ -> 2
  | Lit_str _ -> 3
...
let ctor_index_terms : terms -> int = function
  | Terms_nil -> 0
  | Terms_cons _ -> 1
let wire_tag_terms : terms -> int = function
  | Terms_nil -> 0
  | Terms_cons _ -> 1
...
let ctor_index_cause_term : cause_term -> int = function
  ...
  | Cause_term_both _ -> 3
let wire_tag_cause_term : cause_term -> int = function
  | Cause_term_fail _ -> 0
  | Cause_term_die _ -> 1
  | Cause_term_interrupt _ -> 2
  | Cause_term_both _ -> 3
...
let ctor_index_mask_mode : mask_mode -> int = function
  ...
  | Mask_mode_inherit -> 2
let wire_tag_mask_mode : mask_mode -> int = function
  | Mask_mode_interruptible -> 0
  | Mask_mode_uninterruptible -> 1
  | Mask_mode_inherit -> 2
...
let wire_tag_fork_options (_ : fork_options) : int = 0
...
let wire_tag_observer_mode : observer_mode -> int = function
  | Observer_mode_awaitValue -> 0
  | Observer_mode_joinEffect -> 1
...
let wire_tag_finalizer_strategy : finalizer_strategy -> int = function
  | Finalizer_strategy_sequential -> 0
  | Finalizer_strategy_parallel -> 1
...
let wire_tag_service_name (_ : service_name) : int = 0
...
let wire_tag_service_type_code (_ : service_type_code) : int = 0
...
let wire_tag_service_key (_ : service_key) : int = 0
...
and layer_term =
  ...
  | Layer_term_ref of int list
  | Layer_term_mergeAll of layer_terms

and layer_terms =
  | Layer_terms_nil
  | Layer_terms_cons of layer_term * layer_terms
...
let ctor_index_eff : eff -> int = function
  ...
  | Eff_withFiber _ -> 16
  | Eff_scoped _ -> 17
  | Eff_acquireRelease _ -> 18
  | Eff_provideLayer _ -> 19
  | Eff_service _ -> 20
  | Eff_provideService _ -> 21
  | Eff_catchIf _ -> 22
  | Eff_select _ -> 23
  | Eff_iterate _ -> 24
...
let ctor_index_stmt : stmt -> int = function
  ...
  | Stmt_whileTrue _ -> 4
  | Stmt_breakLoop -> 5
let wire_tag_stmt : stmt -> int = function
  | Stmt_bindYield _ -> 0
  | Stmt_yieldDiscard _ -> 1
  | Stmt_ret _ -> 2
  | Stmt_ifElse _ -> 3
...
let ctor_index_stmts : stmts -> int = function
  | Stmts_nil -> 0
  | Stmts_cons _ -> 1
let wire_tag_stmts : stmts -> int = function
  | Stmts_nil -> 0
  | Stmts_cons _ -> 1
...
let ctor_index_effs : effs -> int = function
  | Effs_nil -> 0
  | Effs_cons _ -> 1
let wire_tag_effs : effs -> int = function
  | Effs_nil -> 0
  | Effs_cons _ -> 1
...
let ctor_index_layer_term : layer_term -> int = function
  ...
  | Layer_term_ref _ -> 8
  | Layer_term_mergeAll _ -> 9
let wire_tag_layer_term : layer_term -> int = function
  | Layer_term_succeed _ -> 0
  | Layer_term_effect _ -> 1
  | Layer_term_effectDiscard _ -> 2
  | Layer_term_provide _ -> 3
...
let ctor_name_layer_term : layer_term -> string = function
  ...
  | Layer_term_ref _ -> "ref"
  | Layer_term_mergeAll _ -> "mergeAll"
let ctor_names_layer_term : string list = ["succeed"; "effect"; "effectDiscard"; "provide"; "provideMerge"; "merge"; "fresh"; "orDie"; "ref"; "mergeAll"]

let ctor_index_layer_terms : layer_terms -> int = function
  | Layer_terms_nil -> 0
  | Layer_terms_cons _ -> 1
let wire_tag_layer_terms : layer_terms -> int = function
  | Layer_terms_nil -> 0
  | Layer_terms_cons _ -> 1
let ctor_name_layer_terms : layer_terms -> string = function
  | Layer_terms_nil -> "nil"
  | Layer_terms_cons _ -> "cons"
let ctor_names_layer_terms : string list = ["nil"; "cons"]
...
let ctor_index_row_kind : row_kind -> int = function
  ...
  | Row_kind_async -> 1
  | Row_kind_program -> 2
let wire_tag_row_kind : row_kind -> int = function
  | Row_kind_sync -> 0
  | Row_kind_async -> 1
  | Row_kind_program -> 2
...
let ctor_index_row_shape : row_shape -> int = function
  ...
  | Row_shape_method -> 3
let wire_tag_row_shape : row_shape -> int = function
  | Row_shape_call -> 0
  | Row_shape_value -> 1
  | Row_shape_tupleCall -> 2
  | Row_shape_method -> 3
let ctor_name_row_shape : row_shape -> string = function
  ...
  | Row_shape_method -> "method"
let ctor_names_row_shape : string list = ["call"; "value"; "tupleCall"; "method"]
...
let ctor_index_registration : registration -> int = function
  | Registration_deferred -> 0
  | Registration_external -> 1
let wire_tag_registration : registration -> int = function
  | Registration_deferred -> 0
  | Registration_external -> 1
let ctor_name_registration : registration -> string = function
  | Registration_deferred -> "deferred"
  | Registration_external -> "external"
...
let wire_tag_row (_ : row) : int = 0
let ctor_name_row (_ : row) : string = "mk"
let ctor_names_row : string list = ["mk"]
let field_names_row : string list = ["name"; "spelling"; "shape"; "trailing"; "kind"; "request"; "answer"; "error"; "requires"; "cite"; "typeArgs"; "registration"]
...
let wire_tag_eff_ty (_ : eff_ty) : int = 0
