...
let rec json_eff_ty (r : eff_ty) : Eff_json_text.t =
  Eff_json_text.Object [("answer", json_ty r.eff_ty_answer); ("error", json_ty r.eff_ty_error); ("requires", Eff_json_text.Array (List.map json_service_key r.eff_ty_requires))]
