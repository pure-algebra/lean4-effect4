...
`EffectsTest/Algebra/ExtractionContract.lean`, and its counterexample rows live in that
repository at `test/contracts/algebra-extraction.contract.md`. Effect4 consumes the algebra through the
