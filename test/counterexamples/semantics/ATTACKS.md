...
## E4-SEM-CE-012 — a memoized rebuild as a second construction
...
## E4-SEM-CE-013 — release in construction order
...
## E4-SEM-CE-014 — `close` as a memo-table reset
...
## E4-SEM-CE-015 — what a layer trace does not say
