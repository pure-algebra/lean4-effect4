...
Every theorem in the file, plus `decidableProgramWF`, which is DATA: a decision
procedure that leaned on `Classical.choice` would not be one, so its axiom set
is printed for the same reason the theorems' are.

No `sorry`, no `axiom`, no `native_decide`, and no `#eval` carrying a claim.
`Classical.choice` appears nowhere: the file imports only `Cas.Lang.Defun` for
`PProg`/`PLine`/`PIn` and proves everything else from scratch, which is why the
`EC1-CE030` re-proof in §7 costs no classical axiom (the register's own witness
inherits one from `List.mergeSort` through `Cas/Backend/Canon.lean`). -/

#print axioms EffectCoreT010.memB_iff
#print axioms EffectCoreT010.memB_eq_false_iff
#print axioms EffectCoreT010.distinctB_iff
#print axioms EffectCoreT010.ascendingB_iff
#print axioms EffectCoreT010.dedupLast_keys_sub
#print axioms EffectCoreT010.dedupLast_keys_distinct
#print axioms EffectCoreT010.optAllB_iff
#print axioms EffectCoreT010.destOkB_iff
#print axioms EffectCoreT010.termRefsOkB_iff
#print axioms EffectCoreT010.idsB_iff
#print axioms EffectCoreT010.typesOkB_iff
#print axioms EffectCoreT010.typesB_iff
#print axioms EffectCoreT010.rowsB_iff
#print axioms EffectCoreT010.regionAcyclicB_iff
#print axioms EffectCoreT010.exitRoutingB_iff
#print axioms EffectCoreT010.regionsB_iff
#print axioms EffectCoreT010.handlersB_iff
#print axioms EffectCoreT010.resumeB_iff
#print axioms EffectCoreT010.fiberOkB_iff
#print axioms EffectCoreT010.fibersB_iff
#print axioms EffectCoreT010.pInInternalB_iff
#print axioms EffectCoreT010.lineInternalB_iff
#print axioms EffectCoreT010.bodyClosedFromB_iff
#print axioms EffectCoreT010.scopeNestedB_iff
#print axioms EffectCoreT010.resourcesB_iff
#print axioms EffectCoreT010.foreignOkB_iff
#print axioms EffectCoreT010.foreignB_iff
#print axioms EffectCoreT010.closeOkB_iff
#print axioms EffectCoreT010.entryB_iff
#print axioms EffectCoreT010.aerB_iff
#print axioms EffectCoreT010.presentationB_iff
#print axioms EffectCoreT010.runClauses_ok_iff
#print axioms EffectCoreT010.runClauses_error_condemns
#print axioms EffectCoreT010.clauses_sound
#print axioms EffectCoreT010.clauses_complete
#print axioms EffectCoreT010.checkClauses_ok_iff
#print axioms EffectCoreT010.decidableProgramWF
#print axioms EffectCoreT010.check_ok_clauses
#print axioms EffectCoreT010.check_sound
#print axioms EffectCoreT010.check_complete
#print axioms EffectCoreT010.check_error_iff
#print axioms EffectCoreT010.evidence_carrier_makes_T010_a_projection
#print axioms EffectCoreT010.evidence_is_the_field
#print axioms EffectCoreT010.evidence_is_the_field_is_the_projection
#print axioms EffectCoreT010.wNorm_admits
#print axioms EffectCoreT010.wRaw_rejected
#print axioms EffectCoreT010.normalize_wRaw
#print axioms EffectCoreT010.wNorm_wf
#print axioms EffectCoreT010.wRaw_not_wf
#print axioms EffectCoreT010.normalize_then_check_cannot_prove_T010
#print axioms EffectCoreT010.check_accepts
#print axioms EffectCoreT010.check_rejects
#print axioms EffectCoreT010.wRich_admits
#print axioms EffectCoreT010.wRich_wf
#print axioms EffectCoreT010.check_accepts_a_nondegenerate_program
#print axioms EffectCoreT010.wRich_aer
#print axioms EffectCoreT010.programWF_normalizeRaw_forward_is_false
#print axioms EffectCoreT010.dedupLastBy_id_of_distinct
#print axioms EffectCoreT010.normalizeRaw_id_of_ids
#print axioms EffectCoreT010.presentation_follows_from_ids
#print axioms EffectCoreT010.aer_synthesis_agrees
#print axioms EffectCoreT010.synthAER_uniqueness_needs_no_premise
#print axioms EffectCoreT010.declared_reading_is_strictly_stronger
