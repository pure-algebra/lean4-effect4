...
Frozen by the wave-1b breaker before `Effect4/Surface/JsonSchema.lean` exists,
...
namespace Effect4Test.Surface.JsonSchemaContract
...
end Effect4Test.Surface.JsonSchemaContract
