...
for that, so per `Effect4Test/AGENTS.md` the rejected declaration is recorded
...
namespace Effect4Test.Surface.DeriveContract
...
end Effect4Test.Surface.DeriveContract
