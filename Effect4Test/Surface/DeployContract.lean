...
Frozen by the wave-1b breaker before `Effect4/Surface/Deploy.lean` exists,
...
namespace Effect4Test.Surface.DeployContract
...
end Effect4Test.Surface.DeployContract
