...
`Effect4Test/Audit/AxiomGate.lean` records, in the wave that lands it.
...
import Effect4Test.Surface.FactsContract
import Effect4Test.Surface.KindContract
import Effect4Test.Surface.EntityContract
import Effect4Test.Surface.JsonSchemaContract
import Effect4Test.Surface.ApiContract
import Effect4Test.Surface.AgentContract
import Effect4Test.Surface.DeployContract
import Effect4Test.Surface.SiteContract
import Effect4Test.Surface.IngestContract
import Effect4Test.Surface.EmitContract
import Effect4Test.Surface.DeriveContract

set_option autoImplicit false

namespace Effect4Test.Surface.SurfaceAxiomReport
...
#print axioms Effect4Test.Surface.KindContract.userRep_struct
#print axioms Effect4Test.Surface.KindContract.userRep_json
#print axioms Effect4Test.Surface.KindContract.userIdRep_struct
#print axioms Effect4Test.Surface.KindContract.userIdRep_json
#print axioms Effect4Test.Surface.KindContract.userRep_json_at_128
#print axioms Effect4Test.Surface.EntityContract.shop_wf
#print axioms Effect4Test.Surface.EntityContract.user_wf
#print axioms Effect4Test.Surface.EntityContract.user_key_is_required
#print axioms Effect4Test.Surface.EntityContract.shop_entities_wf
#print axioms Effect4Test.Surface.JsonSchemaContract.user_round_trip
#print axioms Effect4Test.Surface.ApiContract.getUser_wf
#print axioms Effect4Test.Surface.ApiContract.shopApi_wf
#print axioms Effect4Test.Surface.ApiContract.getUser_params_match
#print axioms Effect4Test.Surface.ApiContract.shopApi_routes_nodup
#print axioms Effect4Test.Surface.AgentContract.shopTools_wf
#print axioms Effect4Test.Surface.DeployContract.shopWorker_wf
#print axioms Effect4Test.Surface.DeployContract.shopWorker_satisfies
#print axioms Effect4Test.Surface.SiteContract.shopSite_wf
#print axioms Effect4Test.Surface.SiteContract.shopSite_resolves
#print axioms Effect4Test.Surface.EmitContract.modeled_has_receipt
#print axioms Effect4Test.Surface.EntityContract.user_clauses
#print axioms Effect4Test.Surface.ApiContract.getUser_clauses
#print axioms Effect4Test.Surface.DeployContract.shopWorker_clauses
#print axioms Effect4Test.Surface.SiteContract.shopSite_clauses
#print axioms Effect4Test.Surface.DeriveContract.getUser_derived_wf
#print axioms Effect4Test.Surface.DeriveContract.crudGroup_derived_wf
#print axioms Effect4Test.Surface.DeriveContract.derivedThenEdited_wf
#print axioms Effect4Test.Surface.DeriveContract.model_get_put

end Effect4Test.Surface.SurfaceAxiomReport
