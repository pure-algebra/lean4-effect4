...
namespace Effect4Test.Counterexamples.Surface.Site
...
-- `Effect4Test/Surface/SiteContract.lean` pins the second page's route too.
#guard Site.check
  { shopSite with
...
end Effect4Test.Counterexamples.Surface.Site
