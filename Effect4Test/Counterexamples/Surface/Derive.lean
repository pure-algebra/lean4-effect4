...
`Effect4Test/AGENTS.md` each rejected declaration is recorded verbatim in its
...
namespace Effect4Test.Counterexamples.Surface.Derive
...
in this file or in `Effect4Test/Surface/DeriveContract.lean`, and the
...
end Effect4Test.Counterexamples.Surface.Derive
