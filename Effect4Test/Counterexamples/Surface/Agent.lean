...
breaker before `Effect4/Surface/Agent.lean` exists; red until the builder
lands it.
-/
...
namespace Effect4Test.Counterexamples.Surface.Agent
...
end Effect4Test.Counterexamples.Surface.Agent
