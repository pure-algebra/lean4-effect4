...
`E4-SEM-CE-012` through `E4-SEM-CE-015`; `test/counterexamples/semantics/ATTACKS.md`).
...
/-! ## E4-SEM-CE-012: a memoized rebuild is a second construction
...
/-! ## E4-SEM-CE-013: layers are released in construction order
...
/-! ## E4-SEM-CE-014: `close` only drops the memo table
...
/-! ## E4-SEM-CE-015: observer counting and concurrent memo identity
