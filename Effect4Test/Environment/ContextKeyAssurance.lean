...
receipt recorded by `Effect4Test/Environment/AxiomReport.lean`.
...
namespace Effect4Test.Environment.ContextKeyAssurance
...
end Effect4Test.Environment.ContextKeyAssurance
