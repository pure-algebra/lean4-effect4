...
namespace Effect4Test.Schema.SubAlphabetContract
...
separate modules under `Effect4Test/Counterexamples/Schema/` and are imported
by `Effect4Test.lean`.
-/

end Effect4Test.Schema.SubAlphabetContract
