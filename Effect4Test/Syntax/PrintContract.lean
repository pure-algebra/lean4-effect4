...
`Effect4.Syntax.Eff` (the 24 rows of `arms`), per statement form of a generator body, per
...
namespace Effect4Test.Syntax.PrintContract
...
end Effect4Test.Syntax.PrintContract
