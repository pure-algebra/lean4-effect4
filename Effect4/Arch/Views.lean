...
| app | the same schema decoded by rc.112's own codec, the payload beside it | `Target.TypeScript.Schema.generate?` |
...
(`Effect4Test/Arch/ArchContract.lean`). Nothing here is a new Lean type with
