...
inductive RaceName
  ...
  (`generated/traces/fiber/raceImmediateSuccessStopsLaunch.tsv`). -/
  | successThenSecond
  /-- A failure followed by a success
  (`generated/traces/fiber/raceFailureAllowsNextLaunch.tsv`). -/
  | failThenSuccess
  /-- Two failures, retained in order
  (`generated/traces/fiber/raceAllFailuresRetainOrder.tsv`). -/
  | failThenFail
deriving DecidableEq, Repr
