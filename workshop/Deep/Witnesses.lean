...
Pass A positive example 3, plus the three host traces under `generated/traces/fiber/`. -/
...
/-- `generated/traces/fiber/emptyRacePendingUntilInterrupted.tsv`: the empty race is a live
...
/-- `generated/traces/fiber/raceImmediateSuccessStopsLaunch.tsv`: the first entrant's success
...
/-- `generated/traces/fiber/raceFailureAllowsNextLaunch.tsv`: a failure does not settle the
...
/-- `generated/traces/fiber/raceAllFailuresRetainOrder.tsv`: an all-failed race fails with the
