...
A witness is an OCaml source file under `workshop/OCaml5/witnesses/`, run on three hosts by
`workshop/OCaml5/tools/run-witness.sh`:
...
structure Witness (ν : Type u) : Type u where
  name : String
  /-- Path under `workshop/OCaml5/witnesses/`. -/
  source : String
...
Rows transcribed from `workshop/OCaml5/tools/run-witness.sh workshop/OCaml5/witnesses/*.ml`
...
def witness01 : Witness Nat where
  name := "w01-repeated"
  source := "workshop/OCaml5/witnesses/w01-repeated.ml"
...
def witness02 : Witness Nat where
  ...
  source := "workshop/OCaml5/witnesses/w02-double-resume.ml"
...
def witness03 : Witness Nat where
  name := "w03-cancelled"
  source := "workshop/OCaml5/witnesses/w03-cancelled.ml"
...
def witness04 : Witness Nat where
  ...
  source := "workshop/OCaml5/witnesses/w04-unhandled-perform.ml"
...
def witness05 : Witness Nat where
  name := "w05-forwarded"
  source := "workshop/OCaml5/witnesses/w05-forwarded.ml"
...
def witness06 : Witness Nat where
  ...
  source := "workshop/OCaml5/witnesses/w06-nested-shadow.ml"
...
def witness07 : Witness Nat where
  name := "w07-parked"
  source := "workshop/OCaml5/witnesses/w07-parked.ml"
...
def witness08 : Witness Nat where
  ...
  source := "workshop/OCaml5/witnesses/w08-reperform-root.ml"
...
def witness09 : Witness Nat where
  ...
  source := "workshop/OCaml5/witnesses/w09-discontinue-caught.ml"
...
def witness10 : Witness Nat where
  ...
  source := "workshop/OCaml5/witnesses/w10-perform-in-handlers.ml"
...
def witness11 : Witness Nat where
  ...
  source := "workshop/OCaml5/witnesses/w11-shallow-reinstall.ml"
...
def witness12 : Witness Nat where
  name := "w12-drop"
  source := "workshop/OCaml5/witnesses/w12-drop.ml"
...
def witness13 : Witness Nat where
  ...
  source := "workshop/OCaml5/witnesses/w13-runstack-return.ml"
