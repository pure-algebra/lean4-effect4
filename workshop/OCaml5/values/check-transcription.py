#!/usr/bin/env python3
# O3 (values): check that every observation transcribed into workshop/OCaml5/Value.lean is
...
import re, sys
src = open('workshop/OCaml5/Value.lean', encoding='utf-8').read()
obs = {}
for line in open('workshop/OCaml5/values/out/all.tsv', encoding='utf-8').read().splitlines()[1:]:
...
# jsFacts
jsobs = {}
for line in open('workshop/OCaml5/values/out/p_jsrepr.tsv', encoding='utf-8').read().splitlines()[1:]:
