...
#
# The build directory is under the session scratchpad, never inside the repository.
set -euo pipefail
here=$(CDPATH= cd -- "$(dirname -- "$0")" && pwd)
build=${DUNE_BUILD:-/private/tmp/claude-501/-Users-pooks-Dev-lean4-effect4/d87ba830-2e63-4750-815f-2679b36f870a/scratchpad/dune-avatar}
