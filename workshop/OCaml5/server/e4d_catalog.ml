...
let fixture_families =
  [ ("fiber", "workshop/OCaml5/avatar/fibers_fixture.ml");
    ("ref", "workshop/OCaml5/avatar/store_fixtures.ml");
    ("deferred", "workshop/OCaml5/avatar/store_fixtures.ml");
    ("scope", "workshop/OCaml5/avatar/store_fixtures.ml");
    ("layer", "workshop/OCaml5/avatar/store_fixtures.ml");
    ("extra", "workshop/OCaml5/avatar/extra_fixture.ml") ]
...
let inspect (p : program) : E4d_json.t =
  ...
  | Corpus { text; name } ->
    ...
    E4d_json.Obj
      (common
      @ [ ("form", Str "corpus");
          ("source", Str "workshop/OCaml5/avatar/corpus/programs.txt");
