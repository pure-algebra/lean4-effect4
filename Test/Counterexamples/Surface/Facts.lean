...
breaker before `src/Effect4/Surface/Refusal.lean` exists; red until the builder
lands it.
-/
...
namespace Test.Counterexamples.Surface.Facts
...
end Test.Counterexamples.Surface.Facts
