...
Frozen by the wave-1b breaker before `src/Effect4/Surface/Kind.lean` exists, from
...
alphabet-only definitions in `Test/Surface/Fixtures.lean`. Doc comments
...
namespace Test.Surface.KindContract
