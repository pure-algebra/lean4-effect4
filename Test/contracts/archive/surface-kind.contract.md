...
Implementation (owed): `git:70b1571:src/Effect4/Surface/Kind.lean` (four kinds in wave 1a,
extended in place to seven in wave 2a)

Battery: `git:70b1571:Test/Surface/KindContract.lean`

Counterexamples: `E4-SURFACE-CE-001` through `E4-SURFACE-CE-005`

Witnesses: `git:70b1571:Test/Counterexamples/Surface/Kind.lean`
...
receipts in `git:70b1571:Test/Surface/SurfaceAxiomReport.lean`, and the slot
ascriptions of `git:70b1571:Test/Surface/ApiContract.lean`.
