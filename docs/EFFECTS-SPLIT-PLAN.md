...
| EP-7 | License | **RULED (default):** Apache-2.0, as the streams plan assumed; **Effect4 has no `LICENSE` file today**, so this is a new decision for both repositories | any OSI license; the choice must precede the first public tag |
