...
| Derived Api | same driver, `--group Api` | manifest, `tools/Effect4Gen/guards/api.lean`, `Effect4.Api.Frontier`, `Effect4.Store.Canonical` | API and host protocol | `bash scripts/check-generated.sh`; fresh byte comparison, plus carrier guards | reproduced; tested |
| Derived Fold | same driver, `--group Fold` | manifest, `tools/Effect4Gen/guards/fold.lean`, `Effect4.Program.Eff`, `Effect4.Program.Ty` | Program IR fold and algebras | `bash scripts/check-generated.sh`; fresh byte comparison, plus algebra guards | reproduced; tested |
...
| `src/Effect4/Program/Fold.lean` | committed projection | Derived Fold | Derived Fold | Derived Fold | Derived Fold | yes | yes |
| `src/Effect4/Store/PinDerived.lean` | committed projection | Derived Pin | Derived Pin | Derived Pin | Derived Pin | yes | yes |
| `src/Effect4/Api/Derived.lean` | committed projection | Derived Api | Derived Api | Derived Api | Derived Api | yes | yes |
