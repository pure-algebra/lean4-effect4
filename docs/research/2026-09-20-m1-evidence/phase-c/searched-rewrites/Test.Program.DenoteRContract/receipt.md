...
The recorded narrow build and census both returned zero. Fresh build: `✔ [233/233] Built Test.Program.DenoteRContract (1.4s)`. Baseline plain aesop: 2/4 closed, 2 admissible. After `aesop`: 2/4 closed, 2 admissible. Both caps are 20,000. The bank context differs when stated; this comparison does not isolate an effect of shortening proofs.
