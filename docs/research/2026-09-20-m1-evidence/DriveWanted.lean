...
def M1Drive.clockStep_frame (root : NativeEff) (millis : Nat) (s : Stores) : ProofGraph.Obligation ((interpOf root).clockStep millis s =
...
def M1Drive.clockStep_term (root : NativeEff) (millis : Nat) (s : Stores) : ProofGraph.Obligation ((interpR root).clockStep millis s =
...
of the timer store. -/
def M1Drive.clockStep_rel (root : NativeEff) (millis : Nat) (s : Stores) (_hs : StoresOk s) : ProofGraph.Obligation (StoresOk ((interpOf root).clockStep millis s).2 ∧
