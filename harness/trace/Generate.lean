...
def main (args : List String) : IO Unit := do
  ...
  | _ => throw (IO.userError "usage: Generate.lean fixture | masks | golden <program> | programs | types | flow-programs | flow-golden <program> <tape> | oracle | flow-fixture | structured-fixture | flow-types | interrupt-programs | interrupt-golden <program> | scope-fixture | scope-programs | scope-golden <program> | scope-types | admission-probe")
