/**
 * Generated by Effect4 (Effect v4 profile, structured form).
 *
...
/** Lowered from the flow `incr` over `Cell` (structured form). */
...
/** Lowered from the flow `twice` over `Cell` (structured form). */
...
/** Lowered from the flow `chooser` over `Cell` (structured form). */
