...
export const main: Effect.Effect<readonly [boolean, number], never> = Effect.flatMap(Effect.exit(Effect.suspend(() => false ? Effect.fail(7) : Effect.succeed(0))), (a0) => Effect.flatMap(Effect.succeed(causeError(a0)), (a1) => Effect.succeed(pair(isSome(a1), getOrElse(a1, 9)))))
