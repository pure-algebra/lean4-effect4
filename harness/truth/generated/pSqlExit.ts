...
export const main = Effect.scoped(Effect.flatMap(Effect.acquireRelease(Sql.open(":memory:"), (a0, a1) => Sql.close(a0)), (a0) => Effect.exit(a0.unsafe("SELECT a FROM missing", strings()))))
