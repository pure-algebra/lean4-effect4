...
export const main: Effect.Effect<number, never> = Effect.catch(Effect.uninterruptible(Effect.flatMap(Effect.flatMap(Deferred.make<number, number>(), (a0) => Deferred.await(a0)), (a0) => Effect.fail(42))), (a0) => Effect.succeed(0))
