...
| pSqlOrDie | die [{"die":"badName"}] | die [{"die":"effect/sql/SqlError: Failed to execute statement"}] | yes | yes | yes | runSyncExit | same kind (die); payloads compared by eye; tape: 3 calls |
