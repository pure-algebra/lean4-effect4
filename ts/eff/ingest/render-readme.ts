...
const output = `<!-- GENERATED by ts/eff/ingest/render-readme.ts; do not edit. -->
# Ingest
...
if (process.argv.includes("--check")) {
  if (readFileSync(target, "utf8") !== output) throw new Error("ingest README drift")
  console.log("PASS ingest README: generated tables match")
