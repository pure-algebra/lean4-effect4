...
--   lake env lean -M 4096 --run tools/Effect4Gen/Forms.lean --group FormsLaws --imports Effect4.Laws.Program.Authoring.Lifts,Effect4.Program.Authoring.Forms,Effect4.Codegen.Forms --out src/Effect4/Laws/Program/Authoring/Forms.lean
