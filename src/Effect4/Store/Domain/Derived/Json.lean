...
--   lake env lean -M 4096 --run tools/Effect4Gen/Main.lean --group Json --imports Effect4.Store.Domain.Canonical --out src/Effect4/Store/Domain/Derived/Json.lean --append tools/Effect4Gen/guards/json.lean \
