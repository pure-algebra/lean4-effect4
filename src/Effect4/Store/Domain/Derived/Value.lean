...
--   lake env lean -M 4096 --run tools/Effect4Gen/Main.lean --group Value --imports Effect4.Store.Domain.Canonical --out src/Effect4/Store/Domain/Derived/Value.lean --append tools/Effect4Gen/guards/value.lean \
--     Effect4.Store.Val Effect4.Store.Kind Effect4.Store.Shape Effect4.Store.ShapeDoc
-- Carriers read from: Effect4.Store.Carrier.Val, Effect4.Store.Carrier.Kind, Effect4.Store.Domain.Shape
