...
--   lake env lean -M 4096 --run tools/Effect4Gen/Main.lean --group Program --imports Effect4.Program.Native,Effect4.Store.Domain.Canonical,Effect4.Store.Domain.RowCanonical --out src/Effect4/Store/Domain/Derived/Program.lean --append tools/Effect4Gen/guards/program.lean \
