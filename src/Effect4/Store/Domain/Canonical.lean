...
(`ne_of_encode_ne`). The instances below are the primitives of `src/Effect4/Store/Domain/Canonical.lean:
...
open Canonical in
#guard print (some (3 : Nat), "x") = Effect4.Json.arr [Arch.Json.ofNat 3, .str "x"]
open Canonical in
