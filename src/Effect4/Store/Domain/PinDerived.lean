...
--   lake env lean -M 4096 --run tools/Effect4Gen/Main.lean --group Pin --imports Effect4.Store.Domain.Pin,Effect4.Store.Domain.Node --out src/Effect4/Store/Domain/PinDerived.lean --append tools/Effect4Gen/guards/pin.lean --kind Effect4.Store.Pin=source --kind Effect4.Store.Tree=tree \
--     Effect4.Store.PinRole Effect4.Store.Pin Effect4.Store.Tree
-- Carriers read from: Effect4.Store.Domain.Pin, Effect4.Store.Domain.Node
