...
--   lake env lean -M 4096 --run tools\Effect4Gen\Main.lean --group Pin --imports Effect4.Store.Pin,Effect4.Store.Node --out src\Effect4\Store\PinDerived.lean --append tools\Effect4Gen\guards\pin.lean --kind Effect4.Store.Pin=source \
--     Effect4.Store.PinRole Effect4.Store.Pin
-- Carriers read from: Effect4.Store.Pin
