...
A string frame's payload is the string's UTF-8 bytes (`src/Effect4/Store/Domain/Canonical.lean:98-99`),
...
decoder here is the Wire's strict reader (`src/Effect4/Store/Domain/ProgramWire.lean:212-252`: shortest
