...
keyed by the sibling called. Not here: `WF`, `wf`, `payload` and `Machine.reasonsOfVal` — their arms apply *another*
traversal to the child list (`encodeList xs`), a paramorphism over a container.
-/
