import Effect4.Char.Queue.Machine
...
`docs/research/2026-09-05-workshop-char/01-model/02-qinv-clauses.md`. The queue lemmas of
...
time (`docs/research/2026-09-05-workshop-char/01-model/06-guarded-graded.md` section 3). -/
