import Effect4.Char.Conformance.Receipt
...
`Char/Derived.lean`, and `json` as an identity function is retired with
...
`docs/research/2026-09-05-workshop-char/05-registry/03-claims-held-and-monotonicity.md`.
-/
