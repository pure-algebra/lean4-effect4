import Effect4.Char.Conformance.GSet
import Effect4.Char.Conformance.Vector
...
Everything monomorphic in the Char room is generated into `Char/Derived.lean` by
...
second hand module below `Derived.lean`; the choice is recorded in `docs/research/2026-09-05-workshop-cas/NOTES-X.md`
for the coordinator.
-/
