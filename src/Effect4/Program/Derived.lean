-- cut-from: rev=9c6181e5-dirty toolchain=4.33.1 inputs=19ab40329e3c7ebbcbbad7872d37e1f479b3e7bac98f02ec8b2b82b338ac9e29
...
--   lake env lean -M 4096 --run tools/Effect4Gen/Main.lean --group Program --imports Effect4.Program.Native,Effect4.Store.Canonical --out src/Effect4/Program/Derived.lean --append tools/Effect4Gen/guards/program.lean \
...
termination_by structural a
theorem fitsLayerTerms (a : _root_.Effect4.Program.LayerTerms (_root_.Effect4.Program.NativeOp)) :
