...
rc.112 standard keys of `git:70b1571:src/Effect4/Surface/Annotate.lean`, and read by the emitters:
...
kernel-reducible lawful encoding into `Json` in this tree (`git:70b1571:src/Effect4/Surface/Annotate.lean`'s
