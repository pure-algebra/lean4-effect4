import Effect4.Evidence.Char.Evidence
...
(`Effect4/Evidence/Char/Core.lean`, `Guarded.entry`, `Graded.entry`), and a
...
instance is generated in `Evidence/Char/Derived.lean`, and the manifest files
