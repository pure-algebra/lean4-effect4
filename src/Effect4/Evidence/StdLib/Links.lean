...
`arms` table of `Effect4/Syntax/Eff.lean`, one row per constructor with the rc.112 line it
compiles to.
...
a kernel can afford of that is lane B's measurement (`workshop/Cas/NOTES-C.md`). -/
