...
--   lake env lean -M 4096 --run tools/Effect4Gen/Main.lean --group Api --imports Effect4.Api.Frontier,Effect4.Store.Canonical,Effect4.Store.Clock --out src/Effect4/Api/Derived.lean --append tools/Effect4Gen/guards/api.lean \
