...
--   lake env lean -M 4096 --run tools/Effect4Gen/Forms.lean --group Forms --imports Effect4.Program.Authoring.Lifts,Effect4.Codegen.Forms --out src/Effect4/Codegen/Authoring/Forms.lean
