...
def emitModule (ns : String) (pairs : List (String × Name)) : MetaM Unit := do
  ...
  let stamp ← Tools.GeneratedStamp.line "src/OCaml5/Tools/Describe.lean"
    ["Effect4.Machine.Fibers", "Effect4.Machine.Stores", "Effect4.Machine.Context",
     "Effect4.Machine.Scope", "Effect4.Machine.Key"]
  IO.println ("-- " ++ stamp)
