...
-- Regenerate: lake env lean -M4096 --run src/OCaml5/Tools/Describe.lean --module OCaml5.Avatar.Derived.Stores refKey=Effect4.Machine.RefKey deferredKey=Effect4.Machine.DeferredKey err=Effect4.Machine.Err defect=Effect4.Machine.Defect fnName=Effect4.Machine.FnName finName=Effect4.Machine.FinName ctx=Effect4.Machine.Ctx completion=Effect4.Machine.Completion syncOp=Effect4.Machine.SyncOp raceName=Effect4.Machine.RaceName progName=Effect4.Machine.ProgName name=Effect4.Machine.Name actionName=Effect4.Machine.ActionName thunk=Effect4.Machine.Thunk finalizerStrategy=Effect4.FinalizerStrategy scopeState=Effect4.ScopeState scope=Effect4.Scope deferredCell=Effect4.Machine.DeferredCell deferredStore=Effect4.Machine.DeferredStore scopeEntry=Effect4.Machine.ScopeEntry scopeStore=Effect4.Machine.ScopeStore stores=Effect4.Machine.Stores
import OCaml5.Ml.Reflect

namespace OCaml5.Avatar.Derived.Stores
open OCaml5.Ml
...
end OCaml5.Avatar.Derived.Stores
