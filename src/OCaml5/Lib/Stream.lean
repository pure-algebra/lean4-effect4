...
rc.112 census in `git:62c04d9:src/Effect4/StdLib/Rc112.lean:32-34,1301-…`, which pins the digests of
...
| here | rc.112 (`effect` rc.112, pinned in `git:62c04d9:src/Effect4/StdLib/Rc112.lean`) | Eio / Core |
| --- | --- | --- |
