...
/-- The product value frame lives in the shared image combinators. -/
abbrev pairTuple (I : Image α) (J : Image β) : Image (α × β) := Image.tuple2 I J
...
theorem hasTy_causeOf (v : Val) (e : Ty) (allocated : List String) :
    hasTy v (.causeOf e) allocated =
      (match _root_.Effect4.Machine.Val.cause? v with
       | some c => causeAdmits (fun w _ => hasTy w e allocated) e c
       | none => false) := rfl
